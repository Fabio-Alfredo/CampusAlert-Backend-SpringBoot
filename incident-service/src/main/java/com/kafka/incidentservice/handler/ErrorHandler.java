package com.kafka.incidentservice.handler;

import com.kafka.incidentservice.domain.dtos.common.GeneralResponse;
import com.kafka.incidentservice.uitls.error.ErrorTools;
...
public class ErrorHandler {
    ...
    public ResponseEntity<GeneralResponse> BadRequestHandler(MethodArgumentNotValidException ex) {
        return GeneralResponse.getResponse(HttpStatus.BAD_REQUEST, errorTools.errorMap(ex.getBindingResult().getFieldErrors()));
    }
